...
public class ChannelClient {
	...
	String name;
	Channel channel;
	HyperLedgerFabricClient fabClient;
	...
	public HyperLedgerFabricClient getFabClient() {
		return fabClient;
	}
	 ...
	 * @param fabClient
	 */
	public ChannelClient(String name, Channel channel, HyperLedgerFabricClient fabClient) {
		this.name = name;
