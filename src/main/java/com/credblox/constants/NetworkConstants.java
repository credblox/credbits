package com.credblox.constants;
...
public class NetworkConstants {
	...
	public static final String CHANNEL_CONFIG_PATH = "resources/config/channel.tx";
	
	public static final String ORG1_USR_BASE_PATH = "resources/crypto-config" + File.separator + "peerOrganizations" + File.separator
			+ "org1.example.com" + File.separator + "users" + File.separator + "Admin@org1.example.com"
			+ File.separator + "msp";
	
	public static final String ORG2_USR_BASE_PATH = "resources/crypto-config" + File.separator + "peerOrganizations" + File.separator
	...
	public static final String CHAINCODE_1_PATH = "github.com/asset";
	
	public static final String CHAINCODE_1_VERSION = "1";

	public static final String CHAINCODE_2_NAME = "asset1";

	public static final String CHAINCODE_2_PATH = "github.com/asset";
